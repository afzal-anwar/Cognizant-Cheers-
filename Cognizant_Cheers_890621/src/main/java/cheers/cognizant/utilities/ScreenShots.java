	...
	public static void takeScreenshotOnFailure(WebDriver driver) {
		...
		try {
			...
			ImageIO.write(image, "jpg", new File(
					System.getProperty("user.dir") + "\\ScreenShotsOnFailure\\" + System.currentTimeMillis() + ".jpg"));
		} catch (Exception e) {
	...
	public static void takeScreenshot(WebDriver driver) {
		try {
			...
			ImageIO.write(image2, "jpg",
					new File(System.getProperty("user.dir") + "\\ScreenShots\\" + System.currentTimeMillis() + ".jpg"));
		} catch (Exception e) {
			System.out.println("Screenshot Capturing Failed: " + e.getMessage());
		}
